...
namespace WindowsFormsApplication7
{
    public partial class Form5 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            this.videosTableAdapter.Fill(this.databaseDataSet4.videos);
        ...
        {
            // TODO: This line of code loads data into the 'databaseDataSet4.videos' table. You can move, or remove it, as needed.
            this.videosTableAdapter.Fill(this.databaseDataSet4.videos);
